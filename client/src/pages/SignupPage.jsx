...
import { Eye, EyeOff, BookOpen, Trophy, Star, Users } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gradient-to-br from-success-50 to-success-100 flex items-center justify-center p-4">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <h2 className="text-2xl font-semibold text-gray-700">Join the community!</h2>
        ...
        <div className="grid grid-cols-2 gap-4 py-6">
          <div className="text-center">
            ...
            <p className="text-sm text-gray-600 mt-2">Compete & Win</p>
          </div>
          <div className="text-center">
            <div className="bg-white rounded-full p-3 mx-auto w-fit shadow-sm">
              <Users className="h-6 w-6 text-primary-500" />
            </div>
            <p className="text-sm text-gray-600 mt-2">Join Community</p>
          </div>
        </div>
